...
if [[ ! -s "${BEST_FILE}" ]]; then
  echo "[ERROR] Stage-4 center-push training needs a starting checkpoint."
...
echo "[INFO] Stage-4 center-push replay training for ${TASK_NAME}"
...
echo "[INFO] num_envs=128 max_iterations=250 headless=true"
